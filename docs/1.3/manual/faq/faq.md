...
扩缩容服务无需调整 `erda.yml`，直接在部署中心操作即可。详情请参考[扩缩容](../dop/guides/deploy/management.html#扩缩容)介绍
...
1. 进入 **DevOps 平台 > 我的应用 > 部署中心**，点击容器日志，此时显示的是标准输出（stdout）日志。详情请参考[服务日志](../dop/guides/deploy/metrics_logs.html#服务日志)介绍

...
使用大盘后，您的收益：
* 统一平台上的所有图表，达到UI风格一致，提升美观度。<br>
* 展示自定义的指标数据和日志指标数据。<br>
* 操作简单，低代码式操作，敏捷获取数据分析。<br>
* 解决沟通准确性与时间成本问题，拥有了自身的选择权。<br>
* 复杂查询亦可通过表达式解决，无需定制。
...
进入配置图表编辑器，F12点开调试模式，选中想要查看的指标，找到请求路径为api/metadata/groups/xxx的请求，点开预览，找到data-metrics-0的返回结果路径，即可看到fields和tags两类，展开即可查看字段名以及对应的字段含义。

![](http://terminus-paas.oss-cn-hangzhou.aliyuncs.com/paas-doc/2021/04/15/532993ee-e8eb-4781-9457-abdad164dd17.png)

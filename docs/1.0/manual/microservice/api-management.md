...
在 Dice API 设计中心，可以几乎 0 学习成本地使用该产品设计 API 文档。

基于可视化的编辑方式，通过直观而友好的交互界面，不需要了解任何 REST API 规范标准，
也无需具备任何关于API 描述语言的知识，就可以轻松编写出一份具有专业水平的 API 文档。

设计中心完全兼容标准的 OAS 协议，在其他平台托管的 API 文档、代码中生成的 swagger 文件等，都能轻松迁移到 Dice。
API 设计中心输出的文档完全符合 OAS3 协议标准，任何时候都可以交付、迁出文档，一次设计，随处使用。

<!-- API 设计中心的设计思路 -->

Dice API 设计中心将 API 文档托管到代码仓库中，这一设计使得接口描述和接口实现紧密地绑定到一起。
```text
...
![编辑 API 概况](https://terminus-paas.oss-cn-hangzhou.aliyuncs.com/paas-doc/2021/03/03/ddc30f61-81a9-4d1f-be8a-d1557d0d1808.jpg)

#### 3 定义数据模型

建议在定义接口前先定义数据模型。在编辑器左侧目录栏选择数据类型，按指引添加数据类型，并填写参数名称、类型、描述等基本信息。

![定义数据模型](https://terminus-paas.oss-cn-hangzhou.aliyuncs.com/paas-doc/2021/03/03/36db20b3-2706-4a34-906c-fad74cb671ee.png)
...
![编辑方法为 GET 的接口 Summary](https://terminus-paas.oss-cn-hangzhou.aliyuncs.com/paas-doc/2021/03/03/fcbb9192-50cc-4578-8e74-67ba2568aad9.png)
...
![在 Response Body 中引用自定义类型并扩展字段](https://terminus-paas.oss-cn-hangzhou.aliyuncs.com/paas-doc/2021/03/03/e6c66315-521f-48fb-aa1a-24b83887ab70.png)
...
![发布文档到 API 集市](https://terminus-paas.oss-cn-hangzhou.aliyuncs.com/paas-doc/2021/03/03/132f1ade-2186-4721-a60a-b0bb31cb5d11.png)
...
#### 我有文档，如何迁移到 Dice API 设计中心来？

可以将文档保存到代码目录 `.dice/apidocs` 的目录下，然后提交到仓库的某个分支，推送到 Dice 仓库。
...
![API 集市资源预览页](https://terminus-paas.oss-cn-hangzhou.aliyuncs.com/paas-doc/2021/04/15/7a103b49-825e-481e-bf7e-a2b657cf5d35.png)
...
![访问管理的创建页面](https://terminus-paas.oss-cn-hangzhou.aliyuncs.com/paas-doc/2021/04/15/60f31fa0-5b1b-4448-948c-19e68440052c.png)
...
![提出申请调用](https://terminus-paas.oss-cn-hangzhou.aliyuncs.com/paas-doc/2021/04/15/9f881e9b-ea43-40b8-8bd5-a81c89832b26.png)
...
![审批调用申请](https://terminus-paas.oss-cn-hangzhou.aliyuncs.com/paas-doc/2021/04/15/502f1894-93b7-4676-8dba-77a04cf05aa7.png)
...
![客户端详情页查看审批情况](https://terminus-paas.oss-cn-hangzhou.aliyuncs.com/paas-doc/2021/04/15/45e3d3f8-ab2b-4e46-81e7-0dcaae83c18b.png)

审批通过后，进入 API 资源预览页，用客户端 ID 和密钥进行认证后，就可以在平台对接口进行调用测试了。

![对接口进行调用测试](https://terminus-paas.oss-cn-hangzhou.aliyuncs.com/paas-doc/2021/04/15/8fbeefff-cb63-43f9-89bf-c7a787e1ddea.png)
